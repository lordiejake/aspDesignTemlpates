...
public partial class CategoryFormAdmin : System.Web.UI.Page
{
    double icx;
    ...
    protected void btnAddCategory_Click(object sender, EventArgs e)
    {
        try
        {
            try
            {
                ...
                conn.Open();
                System.Data.SqlClient.SqlCommand insertCommand = new System.Data.SqlClient.SqlCommand("Insert into [tbl_categoryWEB] (CategoryName,CategoryStatus,AdministratorID)Values(@CategoryName,@CategoryStatus,@AdministratorID)", conn);
                ...
                insertCommand.Parameters.Add(new SqlParameter("@CategoryName", txtaddcategory.Text));
                insertCommand.Parameters.Add(new SqlParameter("@CategoryStatus", "0"));
                insertCommand.Parameters.Add(new SqlParameter("@AdministratorID", double.Parse(LabelIDS.Text)));
                int queryResult = insertCommand.ExecuteNonQuery();
                if (queryResult == 1)
                {
                    Response.Redirect("CategoryFormAdmin.aspx?Namez=" + lblwelcome.Text + "&IDS=" + LabelIDS.Text + "&EM=" + LabelEmails.Text);
                }
