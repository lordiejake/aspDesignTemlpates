...
<?xml version="1.0" encoding="utf-8"?>
	...
	<div id="wrapper">
		...
		<div id="content">
			<div class="post">
			<div class="post">
				<h1 class="title"><a href="#">Topics</h1>
			</div>
			
		<hr />
			<div>
                <asp:GridView ID="gridDisplayCAtegory" runat="server" 
                    AutoGenerateColumns="False" ShowHeader="False" Width="455px">
                    <Columns>
                        <asp:BoundField DataField="CategoryName" HeaderText="CategoryName">
                            <ItemStyle Font-Bold="True" Font-Size="X-Large" Font-Underline="True" 
                                ForeColor="#006600" />
                        </asp:BoundField>
                    </Columns>
                </asp:GridView>
			...
			<br />
			<div>
                <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">---[Back]Category Page</asp:LinkButton></div>
			<hr />
				<h1 class="title"><a href="#">Welcome to c# Tutorials Duldulao(Topics)</a></h1>
				<div class="entry">
...
In this example English = C# and Mouth= .NET platform. You need a language as a means of communication, in your case you may use C#.C# ASP.NET  Tutorials: Every professional and students are welcome in posting some important matters about learning the ASP.net c#.
			...
			<br />
			    <div>
			        <table>
			            <tr>
			                <td><asp:Label ID="AllTOPICS" runat="server" Font-Bold="True" 
			...
			<br />
			<div>
			    <h2 class="title"><a href="#">List of Topics(w/ threads)</a></h2>
			</div>
			<br />
			<div>
                <asp:Label ID="lblTopicWITH_THREADS" runat="server" Font-Bold="True" 
                    Font-Size="Medium" Font-Underline="True"></asp:Label>
			</div>
			<br />
		<br />
			<div>
                <asp:GridView ID="gridTOPIC_wTHREADS" runat="server" 
                    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
                    Width="462px" Font-Size="Smaller" 
                    onrowcommand="gridTOPIC_wTHREADS_RowCommand">
                    <RowStyle BackColor="#E3EAEB" />
                    <Columns>
                        <asp:BoundField DataField="TopicID" HeaderText="TopicID" />
                        <asp:BoundField DataField="TopicDecription" HeaderText="TopicDecription" />
                        <asp:BoundField DataField="Number_of_Threds" HeaderText="Number_of_Threads" />
			...
			<br />
		<div>
		    <h2 class="title"><a href="#">List of Topics(w/ 0 threads)</a></h2>
		</div>
		<br />
		<div>
                <asp:Label ID="lblTopicWITH_THREADSwithout" runat="server" Font-Bold="True" 
                    Font-Size="Medium" Font-Underline="True"></asp:Label>
		</div>
		<br />
		<br />
        <div>
                ...
                <asp:GridView ID="grid2TOPIC_wTHREADS0" runat="server" 
                    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
                Width="462px" Font-Size="Smaller" 
                    onrowcommand="grid2TOPIC_wTHREADS0_RowCommand">
                    <RowStyle BackColor="#E3EAEB" />
                    <Columns>
                        <asp:BoundField DataField="TopicID" HeaderText="TopicID" />
                        <asp:BoundField DataField="TopicDecription" HeaderText="TopicDecription" />
                        <asp:BoundField DataField="topicstatus" HeaderText="Number_of_Threads" />
                        <asp:CommandField ShowSelectButton="True" />
                    </Columns>
                    <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                    <PagerStyle BackColor="#666666" ForeColor="White" HorizontalAlign="Center" />
        ...
        <div>
            <fieldset>
                <table>
                    ...
                    <tr>
                        <td class="style1">
                            <asp:TextBox ID="txtTopic" runat="server" Height="129px" TextMode="MultiLine" 
                ...
                <table>
                        <tr>
                        <td class="style1">
                            <asp:Button ID="txtSaveTopic" runat="server" Text="Create" Width="219px" 
                                Height="37px" onclick="txtSaveTopic_Click" />
                        </td>
                        <td>  <asp:Label ID="txtCreatetopic" runat="server" Text=""></asp:Label> </td>
                        <td><asp:Label ID="vid" runat="server" Visible="False"></asp:Label></td>
                    </tr>
                    </tr>
                </table>
            </fieldset>
