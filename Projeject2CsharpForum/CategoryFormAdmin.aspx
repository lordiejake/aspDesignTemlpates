<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategoryFormAdmin.aspx.cs" Inherits="CategoryFormAdmin" %>
...
<noscript>
	...
	<embed src="tagClouds.swf" quality="high" bgcolor="#ffffff" width="100%" height="100%" name="tagClouds" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashVars="xmlURL=tagClouds312f1c7ed5cda7c1b14d77cd2f0bbb381318758892.xml"/>
		...
		<div>
		    <h2 class="title"><a href="#">Add Category.</a></h2>    
		</div>
		<div>
		    <fieldset>
		    <table>
		        <tr>
		            <td>CategoryName:</td><td><asp:TextBox ID="txtaddcategory" runat="server" 
                        Width="354px"></asp:TextBox></td>
		        </tr>
		        <tr>
		            <td></td><td><asp:Button ID="btnAddCategory" runat="server" Text="Submit" 
                        onclick="btnAddCategory_Click" Width="193px" /></td>
		        </tr>
		    </table>
		    </fieldset>
		</div>
